...
const foundationData = {
  shalash: {
    name: 'Шалаш', logo: './assets main page/shalash.png', photo: './assets main page/fund-shalash.png', site: 'https://shalash.academy',
  ...
  upsala: {
    name: 'Упсала-Цирк', logo: './assets main page/upsala.png', photo: './assets main page/fund-upsala.png', site: 'https://upsalacircus.ru',
